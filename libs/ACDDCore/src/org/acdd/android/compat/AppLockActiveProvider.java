 ...
 * 用于兼容AppLockActiveProvider因multidex找不到Class
 */
public class AppLockActiveProvider extends ContentProvider {

    private ProviderProxy mProviderProxy;

    public AppLockActiveProvider() {
        mProviderProxy = new ProviderProxy("ks.cm.antivirus.applock.sdkrule.AppLockActiveProvider");
    }
